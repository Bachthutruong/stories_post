    ...
    <Dialog open={isOpen} onOpenChange={(open) => { onOpenChange(open); if(!open) setAgreed(false); }}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="py-4 space-y-4 max-h-60 overflow-y-auto text-sm">
          <p><strong>1. Content Ownership:</strong> You retain ownership of the content you post. By posting, you grant Hẻm Story a license to display and distribute your content.</p>
